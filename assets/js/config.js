...
export const FIELDS = {
  ...
  attendance:[["never","dinî hizmetlere hiç katılmıyor"],["yearly","yılda yaklaşık bir kez katılıyor"],["several_year","yılda birkaç kez katılıyor"],["monthly","ayda yaklaşık bir kez katılıyor"],["weekly","haftada en az bir kez katılıyor"],["unknown","katılım sıklığını belirtmemiş"]]
};
